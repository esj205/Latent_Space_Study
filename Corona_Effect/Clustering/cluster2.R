...
cluster2 <- c( "E5_1","E5_2","E5_3","E5_4","I1_1","I1_2","I1_3","I1_4",
               "I1_5", "I1_6", "I1_7", "K1", "L1_1", "L1_2", "L1_3", "L1_4",
               "L1_5", "L1_6", "L1_7", "M1_1", "M1_2", "M1_3", "M1_4", "M1_5",
               "M1_6", "M1_7", "M1_8", "M1_9", "M1_10", "M1_11", "M1_12")
...
cluster <- spectralClustering(sim, 4)
...
cluster_mean <- rbind(mean_cl1, mean_cl2, mean_cl3, mean_cl4)
cluster_mean
...
text(cluster_mean[,1], cluster_mean[,2],labels = c('cl1','cl2','cl3','cl4') ,pos=1,
     cex=1)
